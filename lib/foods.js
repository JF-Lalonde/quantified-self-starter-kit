      ...
      foods.forEach(function(food){
          $("#foodTable").find('tbody')
            .append($(`<tr id=${food.id} class=list>`)
              .append($(`<td class=edit-name contenteditable=true>${food.name}</td> <td class=edit-calories contenteditable=true>${food.calories}</td><td class=delete-row id=${food.id}><button class=icon-button><span class="glyphicon glyphicon-remove"></span></button></td>`)
